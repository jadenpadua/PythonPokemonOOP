...
class Pikachu(ElectricType):
    ...
    def __init__(self, pokeType,level,hp,attack,electricAbility,specialAbility):
...
#=========================================== 5
pikachu_1 = Pikachu('Electric',34,45,56,"Thunderbolt","Static")
print(pikachu_1.__dict__)
pikachu_1.useSpecialAbility()